...
setwd("~/Desktop/UGA/2022-2023/Spring 2023/MADA 2023/Github/irenecavros-mada-portfolio")
...
aging <- read_csv("data/aging_curve.csv") # taken from SSA: http://www.ssa.gov/oact/NOTES/as120/LifeTables_Tbl_7.html; 2013 is used as base year
